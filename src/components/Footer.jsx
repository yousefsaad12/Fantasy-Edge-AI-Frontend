...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-[#37003c] to-[#da0043] text-white mt-80">
      <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-2xl font-semibold text-[#ffccd5]">Fantasy Edge AI</h2>
          <p className="mt-2 text-[#f0b0bc]">
        ...
        <motion.nav
          ...
          className="flex flex-wrap justify-center mt-8 -mx-5 -my-2"
        >
        ...
        >
          ...
          <p className="text-[#f0b0bc]">Sign up for weekly updates, player insights, and special offers!</p>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex justify-center mt-8 space-x-4 text-sm text-[#f0b0bc]"
        >
          <p>Join 5,000+ FPL managers using AI insights</p>
          <span className="inline-block w-px h-6 bg-[#f0b0bc]" aria-hidden="true"></span>
        ...
        <motion.div
          ...
          className="mt-8 text-center text-[#e8a0b2]"
        >
